...
SELECT DISTINCT kandidat_nr, fornavn, etternavn, virkelig_start_dato, virkelig_slutt_dato, oppdrag_nr, bedrift_navn FROM oppdrag NATURAL JOIN kandidater NATURAL JOIN bedrifter WHERE kandidat_nr=12